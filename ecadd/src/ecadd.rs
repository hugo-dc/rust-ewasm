...
pub fn main() {
    ...
    unsafe {
        //callDataCopy(ret.as_mut_ptr() as *const u32, input_offset, input_length as u32);     // :(
        callDataCopy(ptr_input as *const u32, input_offset, input_length as u32);          // 
        //callDataCopy(input.as_mut_ptr() as *const u32, input_offset, input_length as u32); // works
    }
